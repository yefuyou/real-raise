# 关键数据链改造：发布、迁移与回滚包（2026-07-29 快照）
...
> [!WARNING]
> **历史候选发布包。**
> 本文记录当时的 GO/NO-GO 判断，不代表当前主分支或生产部署状态。
> 当前事实见 [`checkpoints/2026-07-30-baseline.md`](../checkpoints/2026-07-30-baseline.md)，
> 现行发布步骤见 [`operations/DEPLOYMENT.md`](./DEPLOYMENT.md)。
