...
| 当前 Git、生产、契约和已知问题到底是什么状态 | [最新 Checkpoint](./checkpoints/2026-07-30-baseline.md) |
...
- **仓库状态**以最新 Checkpoint 中记录的 commit、工作树和测试为准。
...
Real Raise 是一个“确定性收入计算内核 + Agent 分析层”的个人涨薪诊断应用：
...
5. BYOK 和 Judge 都不是目标产品路径；当前生产仍存在 Judge 后端残留，见最新 Checkpoint。
